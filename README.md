...
<Project Sdk="Microsoft.NET.Sdk">
    ...
    <ItemGroup>
        <PackageReference Include="3DEngine" Version="3.0.80" />
    ...
    <ItemGroup>
        <Content Update="$(NuGetPackageRoot)\3dengine\3.0.80\contentFiles\any\net8.0-windows10.0.22621\Assets\Resources\**\*">
...
Ensure "PreserveNewest" is set for files in the Assets folder in Visual Studio. Replace the Path to the NuGet Package 3DEngine\3.0.80
