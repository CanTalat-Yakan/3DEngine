...
/// <summary>Design-time stub for behavior registration; the source generator provides the partial implementation of <see cref="BuildGenerated(App)"/> to register discovered behaviors.</summary>
